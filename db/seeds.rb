...
admin1 = User.create!(username: "danizraikat", email: "dani@dani.com", password: "password", first_name: "Dani", last_name: "Al-Zraykat", bio: "Happy to be the first user of this website") 
...
note1 = Note.create!(user_id: 1, content: "Today I learnt about Trello")
note2 = Note.create!(user_id: 2, content: "Today I learnt about CSS")
note3 = Note.create!(user_id: 3, content: "Today I learnt about JS")   

comment1 = Comment.create!(user_id: 1, note_id: 2, content: "Nice work")
